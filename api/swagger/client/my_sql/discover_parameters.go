...
type DiscoverParams struct {
	...
	/*Body*/
	Body *models.APIMySQLDiscoverRequest
...
func (o *DiscoverParams) WithBody(body *models.APIMySQLDiscoverRequest) *DiscoverParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the discover params
func (o *DiscoverParams) SetBody(body *models.APIMySQLDiscoverRequest) {
	o.Body = body
}
