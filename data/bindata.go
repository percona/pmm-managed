...
func iatemplatesMysql_downYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "iatemplates/mysql_down.yml", size: 423, mode: os.FileMode(0664), modTime: time.Unix(1607347271, 0)}
...
func iatemplatesMysql_restartedYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "iatemplates/mysql_restarted.yml", size: 679, mode: os.FileMode(0664), modTime: time.Unix(1607347271, 0)}
...
func iatemplatesMysql_too_many_connectionsYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "iatemplates/mysql_too_many_connections.yml", size: 787, mode: os.FileMode(0664), modTime: time.Unix(1607347271, 0)}
