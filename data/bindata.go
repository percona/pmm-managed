...
var _bintree = &bintree{nil, map[string]*bintree{
	"iatemplates": &bintree{nil, map[string]*bintree{
		"mongodb_connections_memory_usage.yml": &bintree{iatemplatesMongodb_connections_memory_usageYml, map[string]*bintree{}},
		"mongodb_high_memory_usage.yml": &bintree{iatemplatesMongodb_high_memory_usageYml, map[string]*bintree{}},
		"mongodb_restarted.yml": &bintree{iatemplatesMongodb_restartedYml, map[string]*bintree{}},
		"mysql_down.yml": &bintree{iatemplatesMysql_downYml, map[string]*bintree{}},
		"mysql_restarted.yml": &bintree{iatemplatesMysql_restartedYml, map[string]*bintree{}},
		"mysql_too_many_connections.yml": &bintree{iatemplatesMysql_too_many_connectionsYml, map[string]*bintree{}},
		"node_high_cpu_load.yml": &bintree{iatemplatesNode_high_cpu_loadYml, map[string]*bintree{}},
		"node_low_free_memory.yml": &bintree{iatemplatesNode_low_free_memoryYml, map[string]*bintree{}},
		"node_swap_filled_up.yml": &bintree{iatemplatesNode_swap_filled_upYml, map[string]*bintree{}},
		"postgresql_down.yml": &bintree{iatemplatesPostgresql_downYml, map[string]*bintree{}},
		"postgresql_restarted.yml": &bintree{iatemplatesPostgresql_restartedYml, map[string]*bintree{}},
		"postgresql_too_many_connections.yml": &bintree{iatemplatesPostgresql_too_many_connectionsYml, map[string]*bintree{}},
	}},
}}
