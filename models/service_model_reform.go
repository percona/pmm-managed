...
func (v *serviceTableType) Columns() []string {
	return []string{"service_id", "service_type", "service_name", "node_id", "environment", "cluster", "replication_set", "custom_labels", "created_at", "updated_at", "address", "port", "queryexamples_disabled"}
}
...
func (s Service) String() string {
	...
	res[12] = "QueryexamplesDisabled: " + reform.Inspect(s.QueryexamplesDisabled, true)
