...
type Agent struct {
	...
	AzureClientID       *string `reform:"azure_client_id"`
	AzureClientSecret   *string `reform:"azure_client_secret"`
	AzureTenantID       *string `reform:"azure_tenant_id"`
	AzureSubscriptionID *string `reform:"azure_subscription_id"`
