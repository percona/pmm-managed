...
func (v *nodeTableType) Columns() []string {
	return []string{"node_id", "node_type", "node_name", "machine_id", "custom_labels", "created_at", "distro", "distro_version", "docker_container_id", "docker_container_name", "instance", "region"}
}
...
func (s Node) String() string {
	...
	res[6] = "Distro: " + reform.Inspect(s.Distro, true)
	res[7] = "DistroVersion: " + reform.Inspect(s.DistroVersion, true)
	res[8] = "DockerContainerID: " + reform.Inspect(s.DockerContainerID, true)
	res[9] = "DockerContainerName: " + reform.Inspect(s.DockerContainerName, true)
	res[10] = "Instance: " + reform.Inspect(s.Instance, true)
