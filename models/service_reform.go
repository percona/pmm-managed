...
func (v *serviceTableType) Columns() []string {
	return []string{"service_id", "service_type", "service_name", "node_id", "custom_labels", "created_at", "address", "port", "unix_socket"}
}
