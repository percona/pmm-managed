...
func (_m *mockAlertManagerService) ReadRules() (string, error) {
	ret := _m.Called()
...
func (_m *mockAlertManagerService) RemoveRulesFile() error {
	ret := _m.Called()
...
func (_m *mockAlertManagerService) ValidateRules(ctx context.Context, rules string) error {
...
func (_m *mockAlertManagerService) WriteRules(rules string) error {
	ret := _m.Called(rules)
