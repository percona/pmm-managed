...
// StartMySQLQuerySelectAction provides a mock function with given fields: ctx, id, pmmAgentID, dsn, query, files, tdp
func (_m *mockAgentsRegistry) StartMySQLQuerySelectAction(ctx context.Context, id string, pmmAgentID string, dsn string, query string, files map[string]string, tdp *models.DelimiterPair) error {
	ret := _m.Called(ctx, id, pmmAgentID, dsn, query, files, tdp)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, string, map[string]string, *models.DelimiterPair) error); ok {
		r0 = rf(ctx, id, pmmAgentID, dsn, query, files, tdp)
	} else {
		r0 = ret.Error(0)
	}
...
// StartMySQLQueryShowAction provides a mock function with given fields: ctx, id, pmmAgentID, dsn, query, files, tdp
func (_m *mockAgentsRegistry) StartMySQLQueryShowAction(ctx context.Context, id string, pmmAgentID string, dsn string, query string, files map[string]string, tdp *models.DelimiterPair) error {
	ret := _m.Called(ctx, id, pmmAgentID, dsn, query, files, tdp)
