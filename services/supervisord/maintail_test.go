...
func TestParseEvent(t *testing.T) {
	t.Run("Normal", func(t *testing.T) {
		...
		expected := []*event{
			...
			{Time: time.Date(2019, 8, 8, 17, 10, 0o1, 932000000, time.UTC), Type: starting, Program: "pmm-managed"},
			{Time: time.Date(2019, 8, 8, 17, 10, 0o3, 6000000, time.UTC), Type: running, Program: "pmm-managed"},
