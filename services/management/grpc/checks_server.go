...
func (s *checksServer) ChangeSecurityCheck(ctx context.Context, req *managementpb.ChangeSecurityCheckRequest) (*managementpb.ChangeSecurityCheckResponse, error) {
	return s.svc.ChangeSecurityCheck(req)
}
