...
func main() {
	...
	versionServiceAPIURLF := kingpin.Flag("version-service-api-url", "Version Service API URL").Envar("PMM_VERSION_SERVICE_API_URL").
		Default("https://check.percona.com/versions/v1").String()
